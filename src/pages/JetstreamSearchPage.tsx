...
function JetstreamSearchPage() {
  ...
  return (
    <>
      ...
      >
        Maps that show a jetstream overlay on the OpenSpace globe.
      </h2>
      <div className="search">
        <div className="modern-date-selection">
          <MapDatePicker
            ...
            placeholder="Choose a date for jetstream data"
            minDate="1900-01-01"
          />
      ...
      >
        ...
        >
          Highest Average World Jetstream:
        </h2>
      ...
      >
        ...
        >
          Lowest Average World Jetstream:
        </h2>
...
export default JetstreamSearchPage;
